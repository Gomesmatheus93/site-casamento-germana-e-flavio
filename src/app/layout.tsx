...
import { Cormorant_Garamond, EB_Garamond, Inter, Sacramento } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({ children }: LayoutProps<"/">) {
  return (
    <html
      lang="pt-BR"
      className={`${cormorant.variable} ${inter.variable} ${sacramento.variable} ${ebGaramond.variable} h-full antialiased`}
    >
